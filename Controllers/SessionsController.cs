...
namespace TattooStudio.Controllers
{
    ...
    public class SessionsController : ControllerBase
    {
        ...
        public SessionsController(TattooStudioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Session>> PostSession(Session session)
        {
            ...
            return CreatedAtAction("GetSession", new { id = session.RowKey }, session);
        }
        ...
        {
            return _context.Sessions.Any(e => e.RowKey == id);
        }
    }
}
