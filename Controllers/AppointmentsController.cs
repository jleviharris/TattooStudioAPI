...
namespace TattooStudio.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public AppointmentsController(TattooStudioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Appointment>> PostAppointment(Appointment appointment)
        {
            ...
            return CreatedAtAction("GetAppointment", new { id = appointment.RowKey }, appointment);
        }
        ...
        {
            return _context.Appointments.Any(e => e.RowKey == id);
        }
    }
}
