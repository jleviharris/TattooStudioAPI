...
namespace TattooStudio.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        public ClientsController(TattooStudioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Client>> PostClient(Client client)
        {
            ...
            return CreatedAtAction("GetClient", new { id = client.RowKey }, client);
        }
        ...
        {
            return _context.Clients.Any(e => e.RowKey == id);
        }
    }
}
